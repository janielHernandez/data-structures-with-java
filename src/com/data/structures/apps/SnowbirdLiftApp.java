package com.data.structures.apps;

import com.data.structures.queues.Queue;
import com.data.structures.queues.QueueList;

public class SnowbirdLiftApp {
    Queue<Gad2Chair> gad2Lift = new QueueList<>(10);
